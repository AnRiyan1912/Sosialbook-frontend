...
export const CardCreatePost = () => {
  ...
  return (
    <div>
      {" "}
      {createPost ? <ModalPostCreate setCreatePost={setCreatePost} /> : ""}
      <div className="col-auto bg-white px-4 pt-4 pb-2 mt-5 rounded-lg">
        <div className="flex gap-2 justify-between items-center">
          ...
          />
          <div
            className="border border-black cursor-pointer w-full rounded-3xl h-9 flex items-center hover:bg-slate-100"
